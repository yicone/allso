...
var soinput_obj = $('#soinput'),
    ...
    autoSO = true,
    engines = [
        // { "Google": ["https://www.google.com/search?q=", "", -88, -145, 127] },
        { "Ask": ["https://www.search.ask.com/web?q=", "https://www.search.ask.com/assets/b/a-logo-small.png", -88, -145, 127] },
        ...
        { "好搜": ["https://www.haosou.com/s?q=", "https://p.ssl.qhimg.com/t0184e4ce3cb83220c1.png", 0, 0, 80] },
        { "百度": ["https://www.baidu.com/s?wd=", "https://www.baidu.com/img/baidu_jgylogo3.gif", -45, -100, 80] }
    ],
...
function set(side, engine_index) {
    ...
    // console.log('engine_config', engine_config)
    set_url[side] = engine_config[0];
    set_top = engine_config[2];
    set_left = engine_config[3];
    set_foot = engine_config[4];
...
function so(side) {
    if ($.trim(soinput_obj[0].value) !== '') {
        ...
        console.log('allso_state', allso_state);
