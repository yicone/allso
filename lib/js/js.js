...
var soinput_obj = $('#soinput'),
    ...
    engines = [
        ...
        { "Ask": ["https://www.search.ask.com/web?q=", -88, -145, 127] },
        { "搜狗": ["https://www.sogou.com/web?query=", 0, 0, 127] },
        { "必应": ["https://cn.bing.com/search?setmkt=zh-cn&setlang=zh-cn&q=", -72, -80, 60] },
        { "好搜": ["https://www.haosou.com/s?q=", 0, 0, 80] },
        { "百度": ["https://www.baidu.com/s?wd=", -45, -100, 80] }
    ],
...
function set(side, engine_index) {
    ...
    set_top = engine_config[1];
    set_left = engine_config[2];
    set_foot = engine_config[3];
